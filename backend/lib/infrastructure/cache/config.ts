...
export const DEFAULT_CACHE_CONFIG: CacheConfig = {
  ...
  l1CacheSize: Number.parseInt(process.env.EMBEDDING_CACHE_L1_SIZE || "1000", 10),
  l1TtlSeconds: Number.parseInt(process.env.EMBEDDING_CACHE_L1_TTL_SECONDS || "300", 10),

  // L2 Redis Cache (24 hours)
  l2TtlSeconds: Number.parseInt(process.env.EMBEDDING_CACHE_L2_TTL_SECONDS || "86400", 10),

  // Redis Connection
  redisMaxRetries: Number.parseInt(process.env.REDIS_MAX_RETRIES || "3", 10),
  redisRetryDelay: Number.parseInt(process.env.REDIS_RETRY_DELAY || "100", 10),
};
