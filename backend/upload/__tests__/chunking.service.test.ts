...
function createMockElement(content: string, type: ParsedElement['type'] = 'text', page = 1): ParsedElement {
  return {
    type,
    content,
    page,
...
describe('Document Chunking Service', () => {
  ...
  describe('Semantic Coherence Testing', () => {
    test('should maintain semantic coherence in chunks', async () => {
      ...
      const elements: ParsedElement[] = [
        createMockElement("This is the first sentence of a coherent thought about artificial intelligence."),
        createMockElement("It continues here with more details about AI applications and their benefits."),
        createMockElement("A new topic starts now about machine learning, which should ideally be in a new chunk if possible."),
        createMockElement("This sentence belongs to the machine learning topic and discusses neural networks.")
      ];
    ...
    test('should create coherent chunks from mixed content types', async () => {
      ...
      const elements: ParsedElement[] = [
        ...
        createMockElement("Data science is an interdisciplinary field that uses scientific methods, processes, algorithms and systems to extract knowledge and insights from structured and unstructured data."),
        createMockElement("Machine Learning Fundamentals", "header"),
        createMockElement("Machine learning is a subset of artificial intelligence that focuses on the use of data and algorithms to imitate the way that humans learn.")
      ];
  ...
  describe('Structure Preservation', () => {
    test('should preserve document structure metadata for tables', async () => {
      const elements: ParsedElement[] = [
        ...
        createMockElement("Column A | Column B | Column C\n-------|--------|--------\nValue 1 | Value 2 | Value 3\nValue 4 | Value 5 | Value 6", "table"),
      ...
      const tableChunk = response.chunks.find(chunk => 
    ...
    test('should preserve list structure', async () => {
      const elements: ParsedElement[] = [
        ...
        createMockElement("• First bullet point\n• Second bullet point\n• Third bullet point", "list"),
      ...
      const listChunk = response.chunks.find(chunk => 
        chunk.content.includes("bullet point") || 
        chunk.metadata.elementTypes.includes('list')
      );
    ...
    test('should handle headers and maintain hierarchy', async () => {
      const elements: ParsedElement[] = [
        ...
        createMockElement("This document covers important topics in data science and machine learning."),
        createMockElement("Chapter 1: Introduction", "header"),
        createMockElement("Data science combines domain expertise, programming skills, and knowledge of mathematics and statistics."),
      ...
      const headerChunks = response.chunks.filter(chunk =>
  ...
  describe('Error Handling', () => {
    test('should handle missing required fields', async () => {
      ...
      await expect(processDocumentChunking(invalidRequest))
        .rejects
        .toThrow();
    });
    ...
    test('should handle API failures gracefully', async () => {
      ...
      await expect(processDocumentChunking(request))
        .rejects
        .toThrow();
    });
    ...
    test('should validate input parameters', async () => {
      ...
      await expect(processDocumentChunking(requestWithoutElements))
        .rejects
        .toThrow();
    });
  });
  ...
  describe('Performance and Metrics', () => {
    test('should provide processing metrics', async () => {
      const elements: ParsedElement[] = [
        createMockElement("Content for performance testing.")
      ];
